...
-(GRStudent*)randomStudent{
    ...
    GRStudent* student = [NSEntityDescription insertNewObjectForEntityForName:@"GRStudent"
                                                       inManagedObjectContext:self.managedObjectContext];
    
    student.score = @((float)arc4random_uniform(201)/ 200 +2);
    student.dateOfBirth = [NSDate dateWithTimeIntervalSince1970:60*60*24*365*arc4random_uniform(32)];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    GRStudent* student = [self randomStudent];
    
    [student.managedObjectContext save:nil];
    
    NSFetchRequest* request = [[NSFetchRequest alloc]init];
    
    NSEntityDescription* description = [NSEntityDescription entityForName:@"GRStudent"
                                                   inManagedObjectContext:self.managedObjectContext];
   ...
   /* NSLog(@"%@",resultArray);
    ...
    for (GRStudent* object in resultArray) {
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"_41_CoreDateTest" withExtension:@"momd"];
 ...
 NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"_41_CoreDateTest.sqlite"];
